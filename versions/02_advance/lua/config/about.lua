...
function M.open()
    ...
    local lines = {
        ...
        "    복원 범위          split, buffer, cursor, fold 상태, terminal 위치, tree 표시/폭, 열린 폴더 경로",
