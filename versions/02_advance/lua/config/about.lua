...
function M.open()
    ...
    local lines = {
        ...
        "    Space e            파일 트리 열기/닫기",
        "    Space bb           버퍼 선택 (Enter 열기/포커스, m 이동, y 복사, d/D 삭제, o/O 나머지 닫기)",
        "    d / D              버퍼 목록에서 삭제/강제 삭제",
        "    m / y              버퍼 목록에서 윈도우 이동/복사",
        ...
        "    Space P0~P9        세션 저장",
        "    Space Tab Tab      탭 목록",
        "    Space Tab n/c/h/l  새 탭/닫기/이전/다음 탭",
        "    Space tt           버퍼 터미널 생성",
