...
function M.open()
    ...
    local lines = {
        ...
        "    Space t            현재 창 토글 터미널",
        "    Space T            버퍼 터미널 생성",
        "    Space Ctrl-t       터미널 선택 (D 종료, O 선택 항목만 유지)",
        ...
        "    Dashboard q        안전 종료, blocker가 있으면 Q 또는 qa!로 강제 종료",
        "    :q                 현재 창 닫기",
        "    :qa                Neovim 종료",
        "    :qa!               강제 종료",
        "",
