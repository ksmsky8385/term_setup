return {
    ...
    config = function()
        ...
        local dashboard_buttons = {
            ...
            dashboard.button("f", "[f] Find file", ":FloatingFindFiles<CR>"),
            dashboard.button("g", "[g] Search text", ":FloatingLiveGrep<CR>"),
            dashboard.button("w", "[w] Change workspace", ":WorkspacePick<CR>"),
            dashboard.button("t", "[t] Toggle tree", ":TreeToggle<CR>"),
            dashboard.button("s", "[s] Settings", ":Settings<CR>"),
            dashboard.button("a", "[a] About Neovim", "<cmd>AboutNeovim<CR>"),
            dashboard.button("q", "[q] Quit Neovim", ":DashboardQuit<CR>"),
        }
